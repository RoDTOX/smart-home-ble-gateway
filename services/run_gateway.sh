...
su -c 'nohup /data/data/com.termux/files/usr/bin/python3 -u /data/data/com.termux/files/home/smart-home-ble-gateway/services/btsnoop_scanner.py >> /data/data/com.termux/files/home/btsnoop_scanner.log 2>&1 &'
